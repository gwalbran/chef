...
class Chef
  class Resource::ImosJenkinsView < Resource::LWRPBase
    # Chef attributes
    identity_attr :name
    provides :imos_jenkins_view

    # Set the resource name
    self.resource_name = :imos_jenkins_view
...
class Chef
  class Provider::ImosJenkinsView < Provider::LWRPBase
...
EOH
    ...
    def load_current_resource
      @current_resource ||= Resource::ImosJenkinsView.new(new_resource.name)
...
Chef::Platform.set(
  resource: :imos_jenkins_view,
  provider: Chef::Provider::ImosJenkinsView,
)
