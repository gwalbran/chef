...
# Search for nodes with this role, when probing nodes
default['nagios']['client_role'] = 'monitored'

# How long (seconds) to keep the status2xml cache file
default['nagios']['status2xml']['max_age'] = 60
