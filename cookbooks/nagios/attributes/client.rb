...
# When accessing nodes from NSP via the public interface, it'll always
# translate to the router address (192.168.100.1)
default['nagios']['allowed_hosts'] = [ '192.168.100.1' ]

# some parameters for reporting chef client runs
default['nagios']['chef_client_warn_sec'] = 600
default['nagios']['chef_client_crit_sec'] = 1200
default['nagios']['chef_client_warn_res'] = 300
default['nagios']['chef_client_crit_res'] = 500
