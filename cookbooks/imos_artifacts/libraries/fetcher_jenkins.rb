  ...
  class FetcherJenkins
    ...
    def cache(artifact_manifest, download_prefix)
      ...
      if need_download?(json, artifact_filename, download_path)
        ...
        Fetcher.download_file(artifact_url, download_path, @username, @password)
    ...
    def get_artifact_md5_via_fingerprint(artifact_url)
      ...
      begin
        ...
        if Fetcher.download_file(fingerprint_url, tmpfile.path, @username, @password)
