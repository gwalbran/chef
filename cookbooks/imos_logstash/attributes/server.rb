...
default['imos_logstash']['indexer']['lumberjack']['ssl_key_path'] = File.join(node['logstash']['instance_default']['basedir'], 'ssl', 'logstash-agent.key')
default['imos_logstash']['indexer']['lumberjack']['ssl_cert_path'] = File.join(node['logstash']['instance_default']['basedir'], 'ssl', 'logstash-agent.crt')
